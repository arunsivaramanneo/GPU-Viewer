...
3. **Ubuntu 19.10 (Eoan)/Ubuntu 19.04 (Disco)/Ubuntu 18.04 (Bionic)/Ubutu 16.04 (Xenial)/Linux Mint 19.x/18.x** users should be able to install this application using the below PPA
